...
export default function LoanPaymentFailedPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white p-6">
      ...
      {/* Failure Message */}
      <h2 className="text-2xl font-bold text-orange-400 mb-4 text-center">LOAN APPLICATION FAILED!</h2>

      <p className="text-center mb-8 max-w-md">
        Your payment could not be completed. Reason:No payment received from you/ invalid mobile money account.
      </p>
